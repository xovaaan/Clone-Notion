    ...
    return(
        <>
         ...
         isMobile && "w-0"
            ...
            onClick={collapse}
             role="button"
             className={cn("h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 absolute dark:hover:bg-neutral-600 transition top-3 right-2 opacity-0 group-hover/sidebar:opacity-100",
